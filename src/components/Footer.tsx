    ...
    <footer className="site-footer">
      <div className="site-width">
        <div className="footer-grid">
          ...
          <div><h3>Nasza oferta</h3><Link href="/kruszywa">Kruszywa budowlane</Link><Link href="/nawozy">Wapno nawozowe</Link><Link href="/odpady">Gospodarka odpadami</Link><Link href="/o-firmie/certyfikaty">Certyfikaty</Link><Link href="/do-pobrania">Druki zamówień i dokumenty</Link></div>
